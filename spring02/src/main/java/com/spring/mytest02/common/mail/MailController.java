package com.spring.mytest02.common.mail;
...
public class MailController {
	...
	public void sendSimpleMail(HttpServletRequest request,HttpServletResponse response)
        ...
        StringBuffer sb = new StringBuffer();
 		...
 		sb.append("</a>");
 		sb.append("http://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9788956746425&orderClick=LAG&Kc=#N'>상품보기</a>");
 		sb.append("</body></html>");
      ...
      //  mailService.sendPreConfiguredMail("테스트 메일입니다.");
		...
		response.setContentType("text/html;chaset=euc-kr");
		PrintWriter out=response.getWriter();
		mailService.sendMail("x9103293@naver.com","테스트메일","테스트메일입니다.");
		mailService.sendPreConfiguredMail("테스트 메일입니다.");
		out.print("메일을 보냈습니다.");*/
